                  ...
                  <div className="form-group">
                    ...
                    <div className="input-icon-wrapper">
                      ...
                      <input 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, maxGuests: e.target.value })}
                        placeholder="e.g., 12" 
                        min="2"
                        required 
                      />
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-icon-wrapper">
                      ...
                      <input 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, fundingGoal: e.target.value })}
                        placeholder="e.g., 500" 
                        min="100"
                        required 
                      />
              ...
              <div className="form-group">
                ...
                <div className="input-icon-wrapper file-input-wrapper">
                  ...
                  <input 
                    ...
                    className="form-control" 
                    id="eventImage"
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, eventImage: e.target.files ? e.target.files[0] : null })}
                    accept="image/*"
                  />
                </div>
            ...
            <div className="form-step">
              ...
              <div className="form-group">
                ...
                <select 
                  ...
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({ ...formData, categoryOfNeed: e.target.value })}
                  required
                >
              ...
              <div className="form-group">
                ...
                <textarea 
                  ...
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, recipientStory: e.target.value })}
              ...
              <div className="form-group">
                ...
                <div className="input-icon-wrapper file-input-wrapper">
                  ...
                  <input 
                    ...
                    className="form-control" 
                    id="recipientImage"
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, recipientPhoto: e.target.files ? e.target.files[0] : null })}
                    accept="image/*"
                  />
                </div>
                <small className="text-muted">
              ...
              <div className="form-group">
                ...
                <textarea 
                  ...
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, fundsUsage: e.target.value })}
